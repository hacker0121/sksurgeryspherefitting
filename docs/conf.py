...
# -*- coding: utf-8 -*-
#
# sksurgeryspherefitting documentation build configuration file, created by
...
# This allows modules to be indexed under the submodule name rather than all appearing under sksurgeryspherefitting
...
# The short X.Y version.
# version = sksurgeryspherefitting.__version__
# The full version, including alpha/beta/rc tags.
# release = sksurgeryspherefitting.__version__
...
htmlhelp_basename = 'sksurgeryspherefittingdoc'
...
latex_documents = [
    ('index', 'sksurgeryspherefitting.tex',
     u'scikit-surgery-sphere-fitting Documentation',
     u'Miguel Xochicale', 'manual'),
]
...
man_pages = [
    ('index', 'sksurgeryspherefitting',
     u'scikit-surgery-sphere-fitting Documentation',
     [u'Miguel Xochicale'], 1)
]
